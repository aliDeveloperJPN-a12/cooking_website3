...
const Group4 = () => {
  return (
    <div className='mt-[50px] xl:flex xl:mb-[50px]'>
        <img src={'/static/images/Rectangle 17.png'} className='w-[380px] h-[281px] absolute lg:w-[850px] lg:h-[500px] lg:rounded-[50px] lg:ml-[90px] xl:w-[450px]'/>
      {/* profile banner */}
      <div className=" rounded-xl h-[170px] w-[300px] bg-[#D27722] relative top-[220px] lg:top-[400px] left-[40px] p-[10px]">
            <div className="w-[277px] h-[67px] flex flex-wrap">
                    ...
                    <div className="ml-[20px] flex flex-wrap">
                        ...
                        <img src={'/static/images/image 20.png'} className='h-[20px] mt-[18px] ml-[10px]'/>
                    </div>
            </div>
        ...
        <div className=''>
            ...
            <div className='m-[20px] border border-[#FFDBB8] rounded-xl p-[20px] xl:w-[700px] xl:ml-[290px] xl:h-[160px]'>
                <img src={'/static/images/Rectangle 21.png'}/>
            ...
            <div className='m-[20px] border border-[#FFDBB8] rounded-xl p-[20px] xl:w-[700px] xl:ml-[290px] xl:h-[160px]'>
                <img src={'/static/images/Rectangle 22.png'}/>
            ...
            <div className='m-[20px] border border-[#FFDBB8] rounded-xl p-[20px] xl:w-[700px] xl:ml-[290px] xl:h-[160px]'>
                <img src={'/static/images/Rectangle 23.png'}/>
